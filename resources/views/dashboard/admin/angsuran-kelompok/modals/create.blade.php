<div class="modal fade" id="createDataAngsuranKelompok" tabindex="-1" aria-labelledby="modalCreateDataAngsuranKelompok">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalCreateDataAngsuranKelompok">Tambah Riwayat Angsuran Kelompok
                    {{ $kelompok_name }} Periode ke - {{ $periode }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form method="post" enctype="multipart/form-data"
                    action="{{ route('riwayat-angsuran-kelompok.store', ['kelompok' => $kelompok, 'pinjaman_kelompok' => $pinjaman_kelompok]) }}">
                    @csrf
                    <div class="row g-3">
                        ...
                        <div class="col-lg-12">
                            <div>
                                ...
                                <input type="date"
                                    value="{{ \Carbon\Carbon::parse($last_angsuran)->format('Y-m-d') }}"
                                    class="form-control" name="tgl_angsuran" id="tgl_angsuran"
                        ...
                        <div class="col-lg-12">
                            <div>
                                ...
                                <input type="text" class="form-control" onkeyup="formatAngsuran(this)"
                                    name="angsuran_dibayarkan" id="angsuran_dibayarkan"
