        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3"> <!-- Added mb-3 class for margin-bottom -->
                    ...
                    <div class="col-sm-7">: {{ $pinjaman->tgl_pencairan == null ? 'Belum Diatur' : \Carbon\Carbon::parse($pinjaman->tgl_pencairan)->isoFormat('D MMMM Y') }}</div>
                </div>
                <div class="row mb-3"> <!-- Added mb-3 class for margin-bottom -->
                    <div class="col-sm-5 fw-medium">Tanggal Pelunasan</div>
                    <div class="col-sm-7">: {{ $pinjaman->tgl_pelunasan == null ? 'Belum Diatur' : \Carbon\Carbon::parse($pinjaman->tgl_pelunasan)->isoFormat('D MMMM Y') }}</div>
                </div>
                <div class="row mb-3"> <!-- Added mb-3 class for margin-bottom -->
