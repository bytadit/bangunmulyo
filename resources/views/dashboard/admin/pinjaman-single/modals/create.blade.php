                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-12">
                            <div>
                                ...
                                <input type="number" min="1" class="form-control" name="jangka_waktu" id="jangka_waktu" placeholder="Masukkan jangka waktu pinjaman (bulan)..." required>
                            </div>
                        </div><!--end col-->
                        <div class="col-lg-12">
                            <label for="keperluan" class="form-label">Keperluan<span style="color: red;">*</span></label>
                            <textarea rows="3" name="keperluan" class="form-control" id="keperluan" required></textarea>
                        </div>
